<%@ Page Title="Empleado" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfEmpleado.aspx.cs" Inherits="AppWebAutoPartes.Maestro.wfEmpleado" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width:50%;"align="center">  <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtIdEmpleado" runat="server" Height="12px" Width="105px" TabIndex="1"></asp:TextBox>
            ...
            <table style="width:50%;"align="center">
                ...
                <tr>
                  ...
                  <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtPtjComisión" runat="server" Height="12px" TabIndex="7" Width="105px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
    ...
    <asp:UpdatePanel ID="aupDetOrd" runat="server">
        <ContentTemplate>
            <table style="width:50%;" align="center">
                <tr>
                    <td colspan="2">
                        <asp:GridView ID="gvEmpleado" runat="server" AllowPaging="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal" OnPageIndexChanging="gvDetalle_PageIndexChanging" PageSize="5">
                            <Columns>
